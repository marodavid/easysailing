				...
				<Grid container spacing={3}>
					<Grid item xs={12} sm={12} md={12} >
								<TypographyTituloTexto variant="h2" style={{color: '#7c73e6'}} >
									{ t('actividades.partyRegalo.titulo')}
								</TypographyTituloTexto>
					</Grid>
					<Grid item xs={12} sm={12} md={12}>
						<CardMedia
							...
							alt={'partyBonoRegalo'}
							height="200"
							image={partyBonoRegalo}
						/>
					</Grid>
					<Grid item xs={12} sm={12} md={12}>
						<TypographyParrafoTexto variant="h5">
							{ t('actividades.partyRegalo.subtitulo')}
						</TypographyParrafoTexto>
						<DivParagraphSeparator />
						<TypographyParrafoTexto variant="h5">
							{ t('actividades.partyRegalo.aclaracion')}
						</TypographyParrafoTexto>
						<DivParagraphSeparator />
						<DivBoton>
...
export default PartyRegaloCard
