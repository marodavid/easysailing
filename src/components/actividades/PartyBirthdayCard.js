...
import partyBirthday from "../../images/actividades/partyBirthday.jpg";
				...
				<Grid container spacing={3}>
					<Grid item xs={12} sm={12} md={12} >
								<TypographyTituloTexto variant="h2" style={{color: '#7c73e6'}} >
									{ t('actividades.partyBirthday.titulo')}
								</TypographyTituloTexto>
					</Grid>
					<Grid item xs={12} sm={12} md={12}>
						<CardMedia
					...
					<Grid item xs={12} sm={12} md={12}>
						<TypographyParrafoTexto variant="h5">
							{ t('actividades.partyBirthday.subtitulo')}
						</TypographyParrafoTexto>
						<DivParagraphSeparator />
						<TypographyParrafoTexto variant="h5">
							{ t('actividades.partyBirthday.aclaracion')}
						</TypographyParrafoTexto>
						<DivParagraphSeparator />
						<DivBoton>
...
export default PartyBirthdayCard
